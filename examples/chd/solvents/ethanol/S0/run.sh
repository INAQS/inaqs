...
## Solute parameters
readonly system="1,3-cyclohexadiene in Ethanol at 298.15K"
readonly qc_input="../../SF_13_cyclohexadiene_ES_BHHLYP.inp"
readonly RQM="CHD"
readonly qmmm_active="cyclohexadiene"

## Solvent Prameters
readonly solvent_name="ethanol_T298.15"
...
function solvate(){
    ...
    genbox -cp ${NAME}.gro -cs ethanol_T298.15.gro -o ${NAME}.gro
...
function run(){
    ...
    time mdrun -nt 1 -v -deffnm ${NAME} -cpi 
    date
}
